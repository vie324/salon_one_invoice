          ...
          <CardContent>
            <Steps
              steps={[
                ...
                {
                  title: "お支払い方法の切替（引き落とし ⇔ お振込み）",
                  body: (
                    <>
                      請求書の詳細ページ「操作」欄の <strong>支払方法</strong> から、
                      <strong>口座振替（引き落とし）とお振込みを切り替え</strong>られます。
                      切り替えると請求書の記載も「ご登録の口座より引き落とし」／「【お振込先】の案内」に自動で変わります。
                      振込先の口座は <StepLink href="/settings">設定 → 自社情報</StepLink> で登録した内容が使われます。
                      ※ 既に振替バッチへ登録済みの請求書は、二重請求を防ぐためバッチ処理後に変更してください。
                    </>
                  ),
                },
                {
